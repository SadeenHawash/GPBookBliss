...
import { FaAngleDown, FaMinus, FaPlug, FaPlus, FaXmark } from 'react-icons/fa6'
        ...
        <div>
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
                ...
                <form className="hidden lg:block">
                    ...
                    {filters.map((section) => (
                    <Disclosure as="div" key={section.id} className="border-b border-divider-color py-6">
                        {({ open }) => (
                        <>
                            <h3 className="-my-3 flow-root">
                            <Disclosure.Button className="flex w-full items-center justify-between bg-transparent py-3 text-sm text-primary hover:text-primary">
