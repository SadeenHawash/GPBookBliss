...
import { Box, Flex, Image, Menu, MenuButton, MenuList, MenuItem, useDisclosure, Drawer, DrawerOverlay, DrawerContent, DrawerBody, Input, Spinner, useToast, Icon, ChakraProvider } from "@chakra-ui/react";
...
const AdminPageNavbar = () => {
    ...
    const links = (
        <Fragment>
            <Menu>
                <MenuButton as={Box} cursor='pointer' position='relative' mr={2} mt={2}>
                ...
                {/* ${getSenderForNotification(authUser, notif.chat.participents)}`; */}
                {notification.map(notif => {
                    //console.log('Notification:', notif);
                    const senderName = notif.chat.isChatGroup 
                        ? `New Message in ${notif.chat.chatName}` 
                        : `New Message From sadeen `
                ...
                <Box borderBottom="1px" borderColor="#eaded0">
                    <Flex h="12" alignItems="center">
                        ...
                        <Icon
                            ...
                            cursor='pointer'
                        /> */}
                        <p className="text-xl font-bold text-primary pt-2">BookBliss</p>
